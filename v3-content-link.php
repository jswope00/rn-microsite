      ...
      <?php if(os_is_post_element_active('title') || os_is_post_element_active('category') || os_is_post_element_active('excerpt')){ ?>
        <div class="post-content-body">
          <?php if(os_is_post_element_active('title')): ?>
            <h4 class="post-title entry-title"><a href="<?php the_field( 'external_link' ); ?>#navbar" target="popup" onclick="window.open('<?php the_field( 'external_link' ); ?>#navbar','popup','width=600,height=600'); return false;"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;<?php the_title(); ?></a></h4>
          <?php endif; ?>
